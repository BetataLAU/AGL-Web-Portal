...
function serializeOrder(row) {
  ...
  return {
    ...
    pickup_company_notes: row.pickup_company_notes || null,
    ...
    delivery_company_notes: row.delivery_company_notes || null,
...
const ORDER_SELECT_SQL = `
  SELECT o.*,
         ...
         pc.notes AS pickup_company_notes,
         ...
         dc.notes AS delivery_company_notes,
